...
exports.getAllBank = async function (req, res) {
    ...
    let JOIN = " TB_ITCTRT ON TB_ITCUST.CUST_GB = TB_ITCTRT.CUST_GB AND TB_ITCUST.CUST_CD = TB_ITCTRT.CUST_CD AND TB_ITCUST.VALID_START_DT = TB_ITCTRT.VALID_START_DT";
